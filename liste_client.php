...
if(!isset($_GET["search"])){
  $requete = $db->query("select * from client limit 100");
}
else{
  $prenom=$_GET["search"];
  //$requete = $db->query("select * from client where prenom='$prenom' limit 100");
  $requete = $db->prepare("select * from client where prenom=:prenom limit 100");
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="user-dashboard-info-box table-responsive mb-0 bg-white p-4 shadow-sm">
          <form  class="form-inline" method="get" action="liste_client.php">
           
            <div class="form-group">
             
              <input type="text" class="form-control" name="search" id="search" aria-describedby="helpId" placeholder="Nom de la personne à rechercher">
               </div>
            <div class="col-md-2">
